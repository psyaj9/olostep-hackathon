        ...
        <section id="home" className="h-screen flex flex-col justify-center items-center text-center text-white bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/background.png')" }}>
            ...
            <div className="space-x-4">
                {isLoggedIn ? (
                    <a
                        href="/home"
                        className="inline-flex items-center bg-teal-500 py-2 px-6 rounded-full hover:bg-teal-400"
                    >
                        Get Started
                        <svg
                ...
                <a
                    href="#features"
                    className="bg-transparent border border-white py-2 px-6 rounded-full hover:border-teal-400"
                >
                    Learn More
                </a>
            </div>
